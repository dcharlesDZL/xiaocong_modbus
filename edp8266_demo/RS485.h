...
{
  #pragma pack()
    if (RS4852.UN2.slaveBuf.funcode == 0x03)      //如果从机返回数据中功能码是03
    {
      ...
      MachinePara.paraTempRangeMin     = HTONS(RS4852.UN2.slaveBuf.tempRangeMin);
      MachinePara.paraTempRangeMax     = HTONS(RS4852.UN2.slaveBuf.tempRangeMax);
      MachinePara.paraSpeedMin         = HTONS(RS4852.UN2.slaveBuf.setConcentration);
      MachinePara.paraSpeedMax         = HTONS(RS4852.UN2.slaveBuf.setSpeed);
      MachinePara.alarm                = RS4852.UN2.slaveBuf.alarm;
      MachinePara.paraRunStatus        = RS4852.UN2.slaveBuf.status;
      MachinePara.paraCurrentMode      = HTONS(RS4852.UN2.slaveBuf.currentMode);
      MachinePara.paraPwrOffMem        = HTONS(RS4852.UN2.slaveBuf.powerOffMem);
